...
# sudo scutil --set HostName "eric's mac"
# sudo scutil --set LocalHostName "eric's mac"
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "eric's mac"
